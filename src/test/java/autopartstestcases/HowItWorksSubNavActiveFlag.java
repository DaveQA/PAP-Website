...
public class HowItWorksSubNavActiveFlag {
    public static WebDriver driver;
    public static String ANSI_RED = "\u001B[31m";
    public static String ANSI_GREEN = "\u001B[32m";
    public static String ANSI_RESET = "\u001B[0m";

    public void howItWorksActiveMainTest(WebDriver driver1) {
        autoPartsSubNavActiveLink(driver1);
        howItWorksSubNavActiveLink();
        newOnYardSubNavActiveLink();
        searchCarInventorySubNavActiveLink();
        partsPricingSubNavActiveLink();
        notifyMeSubNavActiveLink();
    }

    private void autoPartsSubNavActiveLink(WebDriver driver1) {
        driver = driver1;
    ...
    private void newOnYardSubNavActiveLink() {
        returnToAutoPartPage();
        List<WebElement> subNavLinks = driver.findElements(By.cssSelector(".sub-nav a"));
    ...
    private void returnToAutoPartPage() {
        List<WebElement> howItWorksSubNavLink = driver.findElements(By.cssSelector(".sub-nav a"));
        howItWorksSubNavLink.get(1).click();
    }
}
