...
public class AutoPartsSubNavActiveFlag {
    public static WebDriver driver;
    public static String ANSI_RED = "\u001B[31m";
    public static String ANSI_GREEN = "\u001B[32m";
    public static String ANSI_RESET = "\u001B[0m";

    public void autoPartsActiveMainTest(WebDriver driver1) {
    ...
    private void autoPartsSubNavActiveLink(WebDriver driver1) {
        driver = driver1;
        driver.findElement(By.cssSelector(".nav > div:first-child > a")).click();
