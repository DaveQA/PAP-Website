...
public class SearchCarInventorySubNavActiveFlag {
    public static WebDriver driver;
    public static String ANSI_RED = "\u001B[31m";
    public static String ANSI_GREEN = "\u001B[32m";
    public static String ANSI_RESET = "\u001B[0m";

    public void notifyMeActiveMainTest(WebDriver driver1) {
        notifyMeSubNavActiveLink(driver1);
    ...
    private void notifyMeSubNavActiveLink(WebDriver driver1) {
        driver = driver1;
        List<WebElement> subNavLinks = driver.findElements(By.cssSelector(".sub-nav a"));
