...
public class Reviews {
    ...
    public void reviewsMainTest(WebDriver driver1) throws InterruptedException {
    ...
    private void reviewsTitleCheck(WebDriver driver1) {
        goToReviewsPage(driver1);
        try {
            actualTitle = driver.getTitle();
            System.out.println("Reviews Title Page Check");
            ...
            System.out.println(ANSI_RED + "Reviews link not verified, please check the website." + ANSI_RESET);
            System.out.println("===================================================================================");
        }
    }
    ...
    private void reviewsGetAQuoteForm() {
        ...
        quoteFormInputField.get(4).sendKeys("Reviews Page");
...
Thread.sleep(1000);
    ...
    private void goToReviewsPage(WebDriver driver1) {
        driver = driver1;
