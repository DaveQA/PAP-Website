...
public class SellMyCarFAQ {
    ...
    public void sellMyCarFAQMainTest(WebDriver driver1) throws InterruptedException {
        reviewsTitleCheck(driver1);
        reviewsGetAQuoteForm();
        zipCodeBoxInAreaLookUp();
        zipCodeBoxOutOfAreaLookUp();
        returnToTopButtonTest();
    }
    ...
    private void reviewsTitleCheck(WebDriver driver1) {
        ...
        try {
            ...
            System.out.println("Sell My Car FAQ Title Page Check");
            ...
            System.out.println(ANSI_RED + "Sell My Car FAQ link not verified, please check the website." + ANSI_RESET);
            System.out.println("===================================================================================");
        }
    }
    ...
    private void reviewsGetAQuoteForm() throws InterruptedException {
        ...
        quoteFormInputField.get(4).sendKeys("FAQ Page");
    ...
    private void returnToTopButtonTest(){
        goToFAQPage(driver);
        WebElement returnToTopButton = driver.findElement(By.cssSelector("h4"));
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", returnToTopButton);
        driver.findElement(By.cssSelector("h4")).click();
        if(driver.findElement(By.cssSelector(".sub-nav")).isDisplayed()){
            System.out.println("Return To Top button working as intended.");
            System.out.println(ANSI_GREEN + "Test Passed" + ANSI_RESET);
            System.out.println("===================================================================================");
        }else{
            System.out.println(ANSI_RED + "Test Failed" + ANSI_RESET);
            System.out.println(ANSI_RED + "Return to Top button is not working, please check the website." + ANSI_RESET);
            System.out.println("===================================================================================");
        }
    }

    private void goToFAQPage(WebDriver driver1) {
        driver = driver1;
